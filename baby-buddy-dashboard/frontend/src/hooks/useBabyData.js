  ...
  const fetchData = useCallback(async (childId) => {
    try {
      ...
      const [
        ...
        api.getFeedings({ child: c, start_min: sleepMin, limit: 100, ordering: "-start" }),
        ...
        api.getChanges({ child: c, date_min: sleepMin, limit: 100, ordering: "-time" }),
        api.getTummyTimes({ child: c, start_min: sleepMin, limit: 100, ordering: "-start" }),
